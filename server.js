...
const youtube = new YouTube("AIzaSyBdFVZMYk4Ykkgo5bgNbpNs5UmTrF3os-o"); //تعديل اساسي سوي اي بي اي جديد
const hastebins = require("hastebin-gen");
const getYoutubeID = require("get-youtube-id");
const yt_api_key = "AIzaSyBdFVZMYk4Ykkgo5bgNbpNs5UmTrF3os-o"; ///تعديل اساسي سوي اي بي اي جديد
...
client.on("ready", () => {
  ...
  client.user.setActivity(`Ysf is the best`, { type: "Playing" });
});
...
client.on("message", message => {
  if (message.content === prefix + "bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@670318476132614150>`, true) // تعديل اساسي غير الايدي لايدي حسابك
      .setImage("")
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "setVc")) {
    ...
    channelfind.setName(
      `⇒| Voice : ${message.guild.members.filter(m => m.voiceChannel).size}` ///تعديل غير اساسي تعديل اسم روم الفويس اونلاين
    );
    message.channel.send("**Done The Voice  Is Turned On**");
  }
  if (message.content.startsWith(prefix + "vc off")) {
    ...
    message.channel.send("**Done The Voice Is Turned Off**");
  }
